                                ...
                                <div class="mil-menu-right">
                                    <div class="row">
                                        <div class="col-lg-8 mil-mb-60">
                                            ...
                                            <ul class="mil-menu-list">
                                                <li><a href="#" class="mil-light-soft">Coming Soon</a></li>
                                                <li><a href="#" class="mil-light-soft">Coming Soon</a></li>
                                                <li><a href="#" class="mil-light-soft">Coming Soon</a></li>
                                                <li><a href="#" class="mil-light-soft">Coming Soon</a></li>
                                                <li><a href="#" class="mil-light-soft">Coming Soon</a></li>
                                        ...
                                        <div class="col-lg-4 mil-mb-60">
                                            ...
                                            <ul class="mil-menu-list">
                                                <li><a href="privacy-policy.html" class="mil-light-soft">Privacy Policy</a></li>
                                    ...
                                    <div class="row justify-content-between">
                                        ...
                                        <div class="col-md-6 col-lg-5 mil-mb-60">
                                            ...
                                            <p class="mil-light-soft mil-up">Vijay Nagar 136 34 A2 Indore Madhya Pradesh<span class="mil-no-wrap">+91 9755859988</span></p>

                                        </div>
                                        <!-- <div class="col-md-6 col-lg-5 mil-mb-60">

                                            <h6 class="mil-muted mil-up mil-mb-30">Ampee,India</h6>

                                            <p class="mil-light-soft mil-up">Leehove 40, 2678 MC De Lier, Ampee <span class="mil-no-wrap">+31 174 705 811</span></p>
